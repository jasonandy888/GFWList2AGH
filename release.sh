...
## How to get and use?
# git clone "https://github.com/jasonandy888/GFWList2AGH.git" && bash ./GFWList2AGH/release.sh
...
function GetData() {
    ...
    gfwlist2agh_modify=(
        "https://raw.githubusercontent.com/jasonandy888/GFWList2AGH/main/data/data_modify.txt"
    )
